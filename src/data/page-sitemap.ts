...
const manualPageSitemapEntries: { path: string; images: SitemapImage[] }[] = [
	...
	},
	{
		path: '/rust-hacks/',
		images: [
			img(rustImages.battleRoyaleCombat, 'The Isle Hacks 2026 | ESP & Aimbot', 'The Isle Hacks survival combat preview for undetected PC package'),
			img(rustImages.espWallhack, 'The Isle Hacks ESP | Rust Cheats', 'The Isle Hacks ESP wallhack overlay for Rust'),
		],
	},
	{
