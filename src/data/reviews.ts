...
const reviewOgImage = {
	...
	title: 'The Isle Hacks customer reviews',
	caption: 'The Isle Hacks buyer reviews for ESP soft aim, radar, and cloud DMA',
};
			...
			images: [
				{
					...
					title: `The Isle Hacks review by @${review.handle}`,
