...
export const blogPosts: BlogPostDefinition[] = [
	{
		...
		metaDescription: "Rust patch notes for Chapter 7 Season 3 — buffs, nerfs, and vaults that reshape loadouts. After EAC patches, check IsleHacks updates.",
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					"On big update mornings, confirm <a href=\"https://rust.facepunch.com/\" target=\"_blank\" rel=\"noopener noreferrer\">Facepunch Rust status</a> is healthy before blaming your settings. If you also use IsleHacks in-match, check <a href=\"/updates/\">IsleHacks Updates</a> after Easy Anti-Cheat patches.",
	...
	},
	{
		...
		metaDescription: "Complete IsleHacks guide for PC and controllers — ESP boxes, soft aim, cloud DMA, and EAC maintenance in 2026. Compare the full package and buy.",
		h1: "IsleHacks 2026: The Complete Undetected Guide",
		intro: "Searching for IsleHacks in 2026? This guide covers ESP wallhack, Aimbot, radar, undetected maintenance, and how rust cheats searchers map to the same Windows PC package.",
		...
		sections: [
			{
				...
				paragraphs: [
					...
					"Official seasons and client updates publish through <a href=\"https://rust.facepunch.com/\" target=\"_blank\" rel=\"noopener noreferrer\">Facepunch Rust</a> and <a href=\"https://rust.facepunch.com/\" target=\"_blank\" rel=\"noopener noreferrer\">Rust.com</a>. Anti-cheat context lives on Easy Anti-Cheat. Our <a href=\"/rust-hacks/\">IsleHacks pillar</a> is the commercial landing; this post is the long-form explainer.",
	...
	},
	{
		...
		intro: "Shopping for rust cheats? Use this checklist for ESP wallhack, Aimbot, radar, EAC maintenance, and license length — then cross-check the IsleHacks pillar before checkout.",
	...
	},
	{
		...
		intro: "Configure Rust Aimbot without snapping every fight. This guide covers smoothness, FOV, bone priority, per-weapon profiles, and how Aimbot fits into IsleHacks packages.",
	...
	},
	{
		...
		intro: "Rust ESP (wallhack) shows players, loot, and threats through terrain. Here is how overlays work, what to toggle, and how ESP fits into IsleHacks and rust cheats packages.",
	...
	},
	{
		...
		metaDescription: "Undetected IsleHacks and EAC reality — ESP boxes, soft aim, and cloud DMA rebuilds for PC and controllers. Check Updates before queueing post-patch.",
		h1: "Undetected IsleHacks and Easy Anti-Cheat Reality",
		intro: "Undetected IsleHacks mean active EAC maintenance — not a forever guarantee. Learn the patch-day workflow, where to check status, and how hacks/cheats pages fit together.",
	...
	},
	{
		...
		metaDescription: "IsleHacks vs CheatVault compared — pricing, ESP boxes, soft aim, cloud DMA, EAC detection history, and which package fits BR players in 2026.",
		h1: "IsleHacks vs CheatVault: Honest Comparison",
		intro: "I ran both CheatVault and IsleHacks through the same ranked block last season. Here is the straight comparison — price, features, patch-day behavior, and where each one actually wins.",
	...
	},
	{
		...
		metaDescription: "EliteFN vs IsleHacks — a two-week test of ESP, soft aim, controller support, EAC downtime, and pricing before switching packages in 2026.",
		h1: "I Tried EliteFN for 2 Weeks Before Switching to IsleHacks",
		intro: "EliteFN was the popular pick in my squad's Discord. I gave it fourteen days — same hardware, same playlists — then moved to IsleHacks. This is what actually differed.",
	...
	},
	{
		...
		metaDescription: "IsleHacks vs GhostWare — feature tables, soft aim, ESP boxes, cloud DMA, controller support, EAC history, and honest pros/cons for 2026 buyers.",
		h1: "IsleHacks vs GhostWare: Features, Pricing, and Detection Notes",
		intro: "GhostWare markets hard on \"stealth\" branding. IsleHacks markets on the full BR stack. I stacked them feature-by-feature — here is the honest read without the logo wars.",
